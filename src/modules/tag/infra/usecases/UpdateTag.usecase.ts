...
import { UpdateTagUseCaseDTO, UpdateTagUseCaseResponseDTO } from '../../domain/dtos/usecases/Tag.usecase.dto';
...
@Injectable()
export class UpdateTagUseCase implements UseCaseInterface {
    constructor(
    ...
    async execute({
        ...
        status,
        user_email,
    }: UpdateTagUseCaseDTO): Promise<UpdateTagUseCaseResponseDTO> {
